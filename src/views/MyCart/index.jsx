...
import { updateQuantity, removeFromCart } from "../../store/cart/cartSlice"; // Assuming you have these actions

export default function MyCart() {
  const dispatch = useDispatch();
  const cartItems = useSelector((state) => state.cart.items); // Access items from the Redux cart slice
